...
## Trạng thái
- Bản chạy: v76. v76: trăng NỀN `.moon` (top:7vh ~57px) bị header mobile (safe-area + nav xuống hàng ~140px) đè cắt nửa trên → `@720px .moon{top:calc(env(safe-area-inset-top)+118px); width/height:94px}` cho tròn vành dưới header. (Đây là trăng nền trong `.ocean-bg`, KHÁC trăng trong icon app.)
